...
def apply_runtime_config(defaults_dir: Path, config_dir: Optional[Path] = None) -> Dict[str, Any]:
    ...
    fetch_config = runtime.get("fetch", {}).get("zhihu", {})
...
Examples:
    ...
    parser.add_argument("--limit", type=int, default=None, help="Number of Zhihu hot items to request")
...
def main() -> int:
    ...
    try:
        ...
        output = {"generated": data.get("generated"), "source_type": "zhihu", "articles": source_result.get("articles", [])}
