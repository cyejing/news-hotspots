...
> Automated global tech and AI digest built around a single pipeline and `summary.json`-first workflow.
...
> **"Install news-digest and generate a daily markdown digest every morning at 9am"**
...
A quality-scored, deduplicated digest built from a single pipeline entrypoint:
